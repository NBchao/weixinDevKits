...
import com.weixindevkits.spi.HandlerFactory;
import com.weixindevkits.spi.IMessageHandler;
import com.weixindevkits.util.TokenUtil;
 ...
 *
 * Description: 拦截Url http://www.weixindevkits.org/api/vzhanqun
 *
 * @author NBchao
 */
public class WeixinUrlFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        //Token为weixindevkits.properties中配置的Token
        String token = TokenUtil.get();
        if (isGet) {
            //1.验证消息真实性
            //http://mp.weixin.qq.com/wiki/index.php?title=验证消息真实性
            //URL为http://www.weixindevkits.org/api/公众号
            //成为开发者验证
