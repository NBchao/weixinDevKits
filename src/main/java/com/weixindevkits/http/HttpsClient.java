 ...
 */
package com.weixindevkits.http;
...
public class HttpsClient implements java.io.Serializable {
    ...
    public Response postXml(String url, String xml, boolean needCert) throws WeixinException {
        String partnerId = Configuration.getProperty("weixindevkits.pay.partner.id");
        String certPath = Configuration.getProperty("weixindevkits.http.cert.path");
        String certSecret = Configuration.getProperty("weixindevkits.http.cert.secret");
